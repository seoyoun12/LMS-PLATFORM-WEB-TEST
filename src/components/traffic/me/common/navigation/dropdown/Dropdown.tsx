...
const 학습자료 = [
  ...
  {title: '연령별 학습지도안',href: '/traffic/learning-material/learning-guide'},
  {title: '타기관 자료모음',href: '/traffic/learning-material/reference'}
]
const 온라인교육 = [
...
const 메타버스 = [
  {title: '디지털 교통안전 교육',href: 'https://zep.us/@ctti',isExternal: true}]

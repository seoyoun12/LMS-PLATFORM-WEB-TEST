...
import { Autocomplete, Avatar, Box, Button, Container, FormControl, InputBase, InputLabel, MenuItem, Select, Switch, TextField, Typography } from '@mui/material';
...
const occupationOptions1 = [{type: "여객" , enType:"PASSENGER"} , {type: "화물" , enType:"FREIGHT"}]
const occupationOptions2 = [
    {category:"PASSENGER" ,type:"버스",enType:"BUS" ,isMoreInfo:true},
    {category:"PASSENGER" ,type: "전세버스",enType:"CHARTER_BUS" ,isMoreInfo:true},
    {category:"PASSENGER" ,type: "특수여객",enType:"SPECIAL_PASSENGER" ,isMoreInfo:true},
    {category:"PASSENGER" ,type: "법인택시",enType:"CORPORATE_TAXI" ,isMoreInfo:true},
    {category:"FREIGHT" ,type: "법인화물",enType:"GENERAL_CARGO" ,isMoreInfo:true},
    {category:"PASSENGER" ,type: "개인택시",enType:"PRIVATE_TAXI" ,isMoreInfo:false},
    {category:"FREIGHT" ,type: "용달화물",enType:"INDIVIDUAL_CARGO" ,isMoreInfo:false},
    {category:"FREIGHT" ,type: "개별화물",enType:"CONSIGNMENT" ,isMoreInfo:false},
];
    ...
    maxWidth="sm" >
        <BoxForm component={"form"} >
            ...
            <FormControl fullWidth >
                ...
                <Select labelId="occ1-select-label" id="occ1-select" onChange={(e)=>{onChangeOcc1(e);setShowCompany(false)}} required >
                    {occupationOptions1.map(
                        (occ)=> <MenuItem 
                                    value={occ.enType}  
                                >
                                {occ.type}
            ...
            <FormControl fullWidth >
                ...
                <Select labelId="occ2-select-label" id="occ2-select" onChange={(e)=>onChangeOcc2(e)} required >
                    ...
                    // occupation1 === "PASSENGER" 
                                // ? 
                            occupationOptions2.filter((item)=>item.category === occupation1).map((item)=>
            ...
            <FormControl fullWidth >
                ...
                <Select labelId="regi-select-label" id="regi-select" onChange={(e)=>onChangeVehicleRegi(e)} required >
                    {locationList.map(
                        (locate)=> <MenuItem value={locate.en}>
                                {locate.ko}
                                </MenuItem> 
                        )
                    }

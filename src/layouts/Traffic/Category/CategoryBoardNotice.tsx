...
export function CategoryBoardNotice() {
  ...
  return (
    <Container>
      <Table>
        <TableHead>
          <TableRow sx={{background:'#fbfbfb' , borderTop:'3px solid #333333' , borderBottom:'1px solid #cdcdcd' }} >
            <TableHeaderCell align='center' width='10%' >번호 </TableHeaderCell>
            <TableHeaderCell align='center' width='70%' >제목 </TableHeaderCell>
            <TableHeaderCell align='center' width='20%' >등록일 </TableHeaderCell>
          </TableRow>
        </TableHead>
      </Table>
